...
class pCharacteristicCallbacks : public BLECharacteristicCallbacks {
  void onWrite(BLECharacteristic *pCharacteristic) {
    Serial.println("Running onWrite callback");
...
void health_setup(BLEService *pService) {
  Serial.println("Running health_setup");
  ...
  Serial.println("Running health_setup complete");
}

void health_tick() {
  Serial.println("Running health_tick");
  ...
  Serial.println("Running health_tick complete");
}